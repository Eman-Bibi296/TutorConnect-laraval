<?php $__env->startSection('title', 'Student Registration - TutorConnect'); ?>
    ...
    <div class="auth-card animate-fade-in-up">
        ...
        <form action="/student/register" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" placeholder="e.g. Eman Bibi" value="<?php echo e(old('name')); ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="location" placeholder="e.g. Islamabad, Lahore, Sheikhupura" value="<?php echo e(old('location')); ?>" required>
            </div>
