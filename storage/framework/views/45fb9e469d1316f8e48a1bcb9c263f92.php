...
<head>
    ...
    <title>TutorConnect - <?php echo $__env->yieldContent('title'); ?></title>
        ...
        <nav class="navbar" aria-label="Main Navigation">
            <div class="container">
                ...
                <div class="nav-links" id="navLinks">
                    <a href="/" class="nav-link-custom <?php echo e(request()->is('/') ? 'active' : ''); ?>">
                        <i class="fas fa-home"></i> Home
                    </a>
                    <a href="/about" class="nav-link-custom <?php echo e(request()->is('about') ? 'active' : ''); ?>">
