<?php $__env->startSection('title', 'Book a Session - TutorConnect'); ?>
        ...
        <div class="main-content">
            <div class="booking-card">
                ...
                <div class="tutor-info-banner">
                    <div class="tutor-avatar"><?php echo e(substr($tutor->name, 0, 1)); ?></div>
                ...
                <?php if(session('error')): ?>
                    <div style="padding: 0 24px;">
                        <div class="alert alert-danger"><i class="fa-solid fa-circle-exclamation"></i> <?php echo e(session('error')); ?></div>
                    </div>
                <?php endif; ?>
                <?php if(session('info')): ?>
                    <div style="padding: 0 24px;">
                        <div class="alert alert-info"><i class="fa-solid fa-circle-info"></i> <?php echo e(session('info')); ?></div>
                    </div>
                <?php endif; ?>
