    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($message->sender_type); ?> (ID: <?php echo e($message->sender_id); ?>)</td>
                <td><?php echo e($message->receiver_type); ?> (ID: <?php echo e($message->receiver_id); ?>)</td>
                ...
                <td>
                    ...
                    <button class="btn-delete" onclick="openDeleteModal(<?php echo e($message->id); ?>)">
                        🗑️ Delete
                    </button>
                </td>
            </tr>
...
<div class="toast" id="toast">
    <span id="toastMessage">✅ Message deleted successfully!</span>
...
<script>
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        if (deleteId) {
            ...
            form.action = '/admin/message/delete/' + deleteId;
            form.submit();
        }
    });
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\TutorConnect\resources\views/admin/messages.blade.php ENDPATH**/ ?>