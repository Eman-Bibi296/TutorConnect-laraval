...
<?php $__env->startSection('title', 'Reviews & Ratings'); ?>
    ...
    <div class="reviews-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="rating-summary">
                <div class="rating-number"><?php echo e(number_format($avgRating ?? 0, 1)); ?></div>
                <div class="rating-stars">
                    <?php for($i = 1; $i <= 5; $i++): ?>
                        <?php echo e($i <= ($avgRating ?? 0) ? '★' : '☆'); ?>

                    <?php endfor; ?>
                </div>
                <div style="color: #666;">Based on <?php echo e($totalReviews ?? 0); ?> reviews</div>
            </div>
            ...
            <div class="reviews-list">
                ...
                <div class="review-card">
                    <div class="review-header">
                        <span class="review-student"><?php echo e($review->student->name ?? 'Student'); ?></span>
