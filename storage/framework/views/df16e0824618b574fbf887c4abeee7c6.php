<?php $__env->startSection('title', 'Tutor Dashboard - TutorConnect'); ?>
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($totalRequests); ?></div>
                ...
                <div class="stat-card">
                    <div class="stat-number" style="color: #D97706;"><?php echo e($pendingRequests); ?></div>
                    <div class="stat-label">Pending Requests</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number" style="color: #059669;">
                        ⭐ <?php echo e(number_format($avgRating ?? 5.0, 1)); ?>

                    </div>
                    <div class="stat-label"><?php echo e($totalReviews); ?> Student Reviews</div>
                </div>
            </div>
                    ...
                    <table class="custom-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr>
                                    <td>
                                        <img src="<?php echo e(asset($studentAvatar)); ?>" style="width:30px;height:30px;border-radius:50%;object-fit:cover;margin-right:8px;vertical-align:middle;border:1.5px solid #10B981;" alt="<?php echo e($studentName); ?>" onerror="this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($studentName)); ?>&background=ECFDF5&color=059669'">
                                        <strong><?php echo e($studentName); ?></strong>
                                    </td>
                                    <td><?php echo e($tutor->subject ?? 'Computer Science'); ?></td>
                                    <td><?php echo e($req->student->location ?? 'Islamabad'); ?></td>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $bookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight:700; color:#059669;">Rs <?php echo e(number_format($tutor->hourly_rate ?? 1500)); ?></td>
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <span class="badge-pending"><i class="fas fa-clock"></i> <?php echo e(ucfirst($booking->status)); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <?php if($booking->status == 'confirmed'): ?>
