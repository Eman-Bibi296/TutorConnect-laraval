...
<div class="section-card">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e($review->student->name ?? 'N/A'); ?></td>
                <td><?php echo e($review->tutor->name ?? 'N/A'); ?></td>
                ...
                <td>
                    <!-- ⭐ DELETE BUTTON -->
                    <button class="btn-delete" onclick="openDeleteModal(<?php echo e($review->id); ?>)">
                        🗑️ Delete
                    </button>
                </td>
            </tr>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\TutorConnect\resources\views/admin/reviews.blade.php ENDPATH**/ ?>