<?php $__env->startSection('title', 'Edit Profile - Tutor Portal - TutorConnect'); ?>
        ...
        <div class="main-content">
            <div class="profile-card">
                ...
                <div class="profile-preview">
                    <img id="avatarPreviewImg" src="<?php echo e(asset($tutorAvatar)); ?>" alt="<?php echo e($tutor->name); ?>" onerror="this.src='https://ui-avatars.com/api/?name=<?php echo e(urlencode($tutor->name)); ?>&background=ECFDF5&color=059669'">
                </div>
                ...
                <div class="profile-body">
                    ...
                    <form action="/tutor/profile/update" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="bio" rows="3" required><?php echo e(old('bio', $tutor->bio)); ?></textarea>
                        </div>

                        <div class="form-row">
                            <div class="form-group">
                                <label><i class="fa-solid fa-tag"></i> Hourly Rate (Rs)</label>
                                <input type="number" name="hourly_rate" value="<?php echo e(old('hourly_rate', $tutor->hourly_rate ?? 1500)); ?>" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="availability" value="<?php echo e(old('availability', $tutor->availability ?? 'Monday - Friday: 4:00 PM - 8:00 PM')); ?>">
                            </div>
                        </div>
