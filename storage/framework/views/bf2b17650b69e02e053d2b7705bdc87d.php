...
<?php $__env->startSection('title', 'Reviews & Feedback'); ?>
    ...
    <div class="reviews-wrapper">
        ...
        <div class="main-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($totalReviews); ?></div>
                    <div class="stat-label">TOTAL REVIEWS</div>
                </div>
                <div class="stat-card">
                    <div class="stat-number"><?php echo e($eligibleTutors->count()); ?></div>
            ...
            <div class="my-review-card">
                ...
                <div class="my-review-box">
                    <div class="my-review-stars">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <?php echo e($i <= $myReview->rating ? '★' : '☆'); ?>

                        <?php endfor; ?>
                    </div>
                    <div class="my-review-text">"<?php echo e($myReview->comment); ?>"</div>
                    <div>
                        <!-- ⭐ DELETE FORM - BINA CONFIRM POPUP KE -->
                        <form action="/student/review/delete/<?php echo e($myReview->id); ?>" method="POST" style="display: inline;" id="deleteForm">
                            <?php echo csrf_field(); ?>
