        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button class="btn-delete" onclick="openDeleteModal(<?php echo e($req->id); ?>)">
                        🗑️ Delete
                    </button>
                </td>
            </tr>
...
<div class="modal-overlay" id="deleteModal">
    <div class="modal-box">
        ...
        <p class="modal-message">Are you sure you want to delete this request?</p>
...
<div class="toast" id="toast">
    <span id="toastMessage">✅ Request deleted successfully!</span>
...
<script>
    ...
    document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
        if (deleteId) {
            ...
            form.action = '/admin/request/delete/' + deleteId;
            form.submit();
        }
    });
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\TutorConnect\resources\views/admin/requests.blade.php ENDPATH**/ ?>