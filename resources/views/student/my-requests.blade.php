...
@section('title', 'My Requests - TutorConnect')
                                ...
                                @foreach($requests as $req)
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:right;">
                                            @if($t)
                                                @if($req->status == 'accepted')
                                                    <a href="{{ url('/student/chat-only/' . $t->id) }}" class="btn-table-action btn-action-chat me-1" title="Direct Chat">
                                                        <i class="fa-solid fa-comments"></i> Chat
                                                    </a>
                                                    <a href="{{ url('/student/tutor/' . $t->id) }}" class="btn-table-action btn-action-view">
