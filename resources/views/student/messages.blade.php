        ...
        <div class="conversations-sidebar">
            ...
            <div class="conversations-list" id="conversationsList">
                ...
                @forelse($allTutors as $conv)
                    @if($conv->tutor)
                    <div class="conversation-item" onclick="selectTutor({{ $conv->tutor->id }}, '{{ $conv->tutor->name }}', this)">
                        <div class="conv-avatar-letter">
                            {{ strtoupper(substr($conv->tutor->name, 0, 1)) }}
                        </div>
                        <div class="conv-info">
                            <div class="conv-name">{{ $conv->tutor->name }}</div>
