        ...
        <div class="profile-body">
            ...
            <form action="/tutor/profile/complete" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="bio" rows="3" placeholder="Tell students about your teaching experience...">{{ old('bio', $tutor->bio) }}</textarea>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="availability">
                            ...
                            <option value="Both" {{ $tutor->availability == 'Both' ? 'selected' : '' }}>Both</option>
                        </select>
                    </div>
                </div>
