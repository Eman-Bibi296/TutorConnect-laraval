...
@section('title', 'Home - Expert Learning Platform')
...
<section class="hero-section">
    <div class="container animate-fade-in-up">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <img src="{{ asset('images/hero_banner.jpg') }}" alt="Expert Tutoring Platform" class="hero-image">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="search-filter-card" style="background: white; border-radius: 20px; padding: 25px 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); border: 1px solid #E2E8F0; margin-bottom: 40px;">
            ...
            <div class="mt-3 d-flex justify-content-between align-items-center" style="font-size: 0.85rem; color: #64748B;">
                <span>Showing <strong id="tutorResultCount" style="color:#059669;">{{ $featuredTutors->count() > 0 ? $featuredTutors->count() : 6 }}</strong> verified instructor profiles</span>
        ...
        <div class="row g-4" id="tutorsGrid">
            @if($featuredTutors->count() > 0)
                @foreach($featuredTutors as $tutor)
                    ...
                    @endphp
                    <div class="col-lg-4 col-md-6 tutor-item" data-subject="{{ $tutor->subject }}" data-location="{{ $tutor->location }}" data-name="{{ $tutor->name }}" data-keywords="{{ $tutor->subject }} {{ $tutor->qualification }} {{ $tutor->bio }}">
                        <div style="background: white; border-radius: 20px; padding: 25px; border: 1px solid #E2E8F0; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%; display: flex; flex-direction: column; justify-content: space-between; transition: all 0.3s ease;">
                            <div>
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    <img src="{{ $avatarUrl }}" alt="{{ $tutor->name }}" style="width: 62px; height: 62px; border-radius: 50%; object-fit: cover; border: 2.5px solid #10B981; flex-shrink: 0; box-shadow: 0 4px 10px rgba(16, 185, 129, 0.2);" onerror="this.src='{{ asset('images/burhan.png') }}'">
                                    <div>
                                        <h4 style="font-size: 1.15rem; font-weight: 800; color: #111827; margin: 0;">{{ $tutor->name }}</h4>
                                ...
                                <p style="font-size: 0.88rem; color: #475569; margin-bottom: 6px;"><strong>Subject:</strong> {{ $tutor->subject }}</p>
                                <p style="font-size: 0.82rem; color: #64748B; margin-bottom: 12px; line-height: 1.5;">{{ Str::limit($tutor->bio ?? ($tutor->qualification . ' with proven subject expertise.'), 95) }}</p>
                                <div style="display: flex; justify-content: space-between; background: #F8FAFC; padding: 10px 14px; border-radius: 12px; margin-bottom: 18px; font-size: 0.85rem; border: 1px solid #F1F5F9;">
                                    ...
                                    <span style="color: #059669; font-weight: 800;">Rs {{ number_format($tutor->hourly_rate ?? 1500) }}/hr</span>
                                </div>
                            </div>
                            <div class="d-flex gap-2">
                                <a href="/student/tutor/{{ $tutor->id }}" class="btn w-100" style="background: linear-gradient(135deg, #059669 0%, #10B981 100%); color: white; border-radius: 10px; font-weight: 700; font-size: 0.88rem; padding: 10px;">
                                    <i class="fas fa-calendar-plus me-1"></i> View &amp; Book
                                </a>
                                <a href="/student/chat-only/{{ $tutor->id }}" class="btn" style="background: #111827; color: white; border-radius: 10px; padding: 10px 14px;" title="Chat with Tutor">
            ...
            @else
                ...
                <div class="col-lg-4 col-md-6 tutor-item" data-subject="Computer Science" data-location="Sheikhupura Online" data-name="Dr. Burhan Ahmad" data-keywords="computer science web dev laravel php full stack coding">
                    <div style="background: white; border-radius: 20px; padding: 25px; border: 1px solid #E2E8F0; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%; display: flex; flex-direction: column; justify-content: space-between; transition: all 0.3s ease;">
                        <div>
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <img src="{{ asset('images/burhan.png') }}" alt="Dr. Burhan Ahmad" style="width: 62px; height: 62px; border-radius: 50%; object-fit: cover; border: 2.5px solid #10B981; flex-shrink: 0; box-shadow: 0 4px 10px rgba(16, 185, 129, 0.2);">
                                <div>
                ...
                <div class="col-lg-4 col-md-6 tutor-item" data-subject="Mathematics" data-location="Lahore Online" data-name="Prof. Rabia Tariq" data-keywords="mathematics calculus algebra geometry math">
                    <div style="background: white; border-radius: 20px; padding: 25px; border: 1px solid #E2E8F0; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%; display: flex; flex-direction: column; justify-content: space-between; transition: all 0.3s ease;">
                        <div>
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <img src="{{ asset('images/rabia.jpg') }}" alt="Prof. Rabia Tariq" style="width: 62px; height: 62px; border-radius: 50%; object-fit: cover; border: 2.5px solid #10B981; flex-shrink: 0; box-shadow: 0 4px 10px rgba(16, 185, 129, 0.2);">
                                <div>
                ...
                <div class="col-lg-4 col-md-6 tutor-item" data-subject="Physics" data-location="Lahore Online" data-name="Engr. Ahmad Ali" data-keywords="physics electronics circuits engineering">
                    <div style="background: white; border-radius: 20px; padding: 25px; border: 1px solid #E2E8F0; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%; display: flex; flex-direction: column; justify-content: space-between; transition: all 0.3s ease;">
                        <div>
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <img src="{{ asset('images/ahmad.jpg') }}" alt="Engr. Ahmad Ali" style="width: 62px; height: 62px; border-radius: 50%; object-fit: cover; border: 2.5px solid #10B981; flex-shrink: 0; box-shadow: 0 4px 10px rgba(16, 185, 129, 0.2);">
                                <div>
