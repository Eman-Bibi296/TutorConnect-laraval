...
<section class="stats-bar">
    <div class="container">
        <div class="row">
            <div class="col-6 col-md-3 stat-item"><div class="stat-number">{{ $realStudentCount }}</div><div class="stat-label">Active Students</div></div>
            <div class="col-6 col-md-3 stat-item"><div class="stat-number">{{ $realTutorCount }}</div><div class="stat-label">Verified Tutors</div></div>
             <div class="col-6 col-md-3 stat-item"><div class="stat-number">{{ $realSubjectCount }}</div><div class="stat-label">Subjects Covered</div></div>
            <div class="col-6 col-md-3 stat-item"><div class="stat-number">{{ $realAvgRating ? number_format($realAvgRating, 1) : '5.0' }}/5</div><div class="stat-label">Student Rating</div></div>
        </div>
    </div>
</section>
                    ...
                    <div style="background: white; border-radius: 20px; padding: 25px; border: 1px solid #E2E8F0; box-shadow: 0 4px 15px rgba(0,0,0,0.03); height: 100%; display: flex; flex-direction: column; justify-content: space-between;">
                        <div>
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <img src="{{ $avatarUrl }}" alt="{{ $tutor->name }}" style="width: 62px; height: 62px; border-radius: 50%; object-fit: cover; border: 2.5px solid #10B981; flex-shrink: 0;" onerror="this.src='{{ asset('images/burhan.png') }}'">
                                <div>
