...
<div class="section-card">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $message->id }}</td>
                <td>{{ $message->sender_type }} (ID: {{ $message->sender_id }})</td>
                <td>{{ $message->receiver_type }} (ID: {{ $message->receiver_id }})</td>
                <td>{{ Str::limit($message->message, 50) }}</td>
                <td>{{ $message->created_at->format('M d, Y h:i A') }}</td>
                <td>
                    <!-- ⭐ DELETE BUTTON - CUSTOM MODAL -->
                    <button class="btn-delete" onclick="openDeleteModal({{ $message->id }})">
                        🗑️ Delete
                    </button>
                </td>
            </tr>
